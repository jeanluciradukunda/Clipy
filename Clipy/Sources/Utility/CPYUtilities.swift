...
final class CPYUtilities {
    ...
    static func registerUserDefaultKeys() {
        ...
        defaultValues.updateValue(NSNumber(value: false), forKey: Constants.UserDefaults.searchPanelQuickPasteRequiresCommand)
        defaultValues.updateValue(NSNumber(value: false), forKey: Constants.UserDefaults.snippetPickerQuickPasteRequiresCommand)
